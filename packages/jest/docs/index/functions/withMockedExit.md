...
[@-xun/jest](../../README.md) / [index](../README.md) / withMockedExit

# Function: withMockedExit()

> **withMockedExit**(`test`): `Promise`\<`void`\>

Defined in: packages/jest/node\_modules/@-xun/test-mock-exit/dist/packages/test-mock-exit/src/index.d.ts:10
