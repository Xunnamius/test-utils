...
<p align="center" width="100%">
  <img width="300" src="https://raw.githubusercontent.com/Xunnamius/test-utils/refs/heads/main/packages/common-dummies/logo.png">
</p>
...
```shell
npm install @-xun/common-dummies
```

## Usage

When using `@-xun/common-dummies/repositories`, you must initialize the dummies
before use. This can be done via either an `npm prepare` script (i.e.
`node --no-warnings -e "import('@-xun/common-dummies/post-install')"`) or a
...
[x-badge-codecov-image]:
  https://img.shields.io/codecov/c/github/Xunnamius/test-utils/main?style=flat-square&token=HWRIOBAAPW&flag=package.main_common-dummies
  'Is this package well-tested?'
[x-badge-codecov-link]: https://codecov.io/gh/Xunnamius/test-utils
[x-badge-downloads-image]:
  https://img.shields.io/npm/dm/@-xun/common-dummies?style=flat-square
  'Number of times this package has been downloaded per month'
[x-badge-downloads-link]: https://npmtrends.com/@-xun/common-dummies
[x-badge-lastcommit-image]:
  https://img.shields.io/github/last-commit/Xunnamius/test-utils?style=flat-square
  'Latest commit timestamp'
[x-badge-license-image]:
  https://img.shields.io/npm/l/@-xun/common-dummies?style=flat-square
  "This package's source license"
[x-badge-license-link]:
  https://github.com/Xunnamius/test-utils/blob/main/LICENSE
[x-badge-npm-image]:
  https://xunn.at/npm-pkg-version/@-xun/common-dummies
  'Install this package using npm or yarn!'
[x-badge-npm-link]: https://npm.im/@-xun/common-dummies
