...
function getJestAliases() {
  ...
  return {
    ...
    '^multiverse\\+common\\x2ddummies$': `<rootDir>/packages/common-dummies/src/index.${extension}`,
    '^multiverse\\+jest$': `<rootDir>/packages/jest/src/index.${extension}`,
    '^multiverse\\+test\\x2dmock\\x2dargv$': `<rootDir>/packages/test-mock-argv/src/index.${extension}`,
    '^multiverse\\+test\\x2dmock\\x2denv$': `<rootDir>/packages/test-mock-env/src/index.${extension}`,
    '^multiverse\\+test\\x2dmock\\x2dexit$': `<rootDir>/packages/test-mock-exit/src/index.${extension}`,
    '^multiverse\\+test\\x2dmock\\x2dfixture$': `<rootDir>/packages/test-mock-fixture/src/index.${extension}`,
    '^multiverse\\+test\\x2dmock\\x2dimport$': `<rootDir>/packages/test-mock-import/src/index.${extension}`,
    '^multiverse\\+test\\x2dmock\\x2doutput$': `<rootDir>/packages/test-mock-output/src/index.${extension}`,
    ...
    '^universe\\+test\\x2dmock\\x2doutput:(.+)$':
      '<rootDir>/packages/test-mock-output/src/$1',
    '^universe\\+common\\x2ddummies$': `<rootDir>/packages/common-dummies/src/index.${extension}`,
    '^universe\\+jest$': `<rootDir>/packages/jest/src/index.${extension}`,
    '^universe\\+test\\x2dmock\\x2dargv$': `<rootDir>/packages/test-mock-argv/src/index.${extension}`,
    '^universe\\+test\\x2dmock\\x2denv$': `<rootDir>/packages/test-mock-env/src/index.${extension}`,
    '^universe\\+test\\x2dmock\\x2dexit$': `<rootDir>/packages/test-mock-exit/src/index.${extension}`,
    '^universe\\+test\\x2dmock\\x2dfixture$': `<rootDir>/packages/test-mock-fixture/src/index.${extension}`,
    '^universe\\+test\\x2dmock\\x2dimport$': `<rootDir>/packages/test-mock-import/src/index.${extension}`,
    '^universe\\+test\\x2dmock\\x2doutput$': `<rootDir>/packages/test-mock-output/src/index.${extension}`,
